# -*- coding: utf-8 -*-
"""
研究生新生手册内容 md -> handbook/grad/js/content.js 转换脚本
用法：python build_content.py
输入：../../手册内容/研究生/*.md（按文件名排序）
输出：../js/content.js（window.HANDBOOK_GRAD_DATA）
"""
import json
import os
import re
...
# 手册标识（英文目录名 / 全局数据变量名），每本手册一份独立子站：
#   本科 -> ug，研究生 -> grad，变量名对应 HANDBOOK_UG_DATA / HANDBOOK_GRAD_DATA
BOOK_ID = "grad"

BASE = os.path.dirname(os.path.abspath(__file__))
SRC = os.path.join(BASE, "..", "..", "..", "手册内容", "研究生")
OUT = os.path.join(BASE, "..", "js", "content.js")

# 插图目录与命名规则：
#   handbook/grad/img/ 是该子站唯一插图目录（构建时读取并生成 img/{文件名} 引用）。
...
CHAPTERS = [
    ...
    ("01_信息学院简介.md",             "01", "信息学院简介",             "1"),
    ("02_安全守则.md",                 "02", "安全守则",                 "2"),
    ("03_美食攻略.md",                 "03", "美食攻略",                 "3"),
    ("04_出行指南.md",                 "04", "出行指南",                 "4"),
    ("05_自习场所.md",                 "05", "自习场所",                 "5"),
    ("06_运动场所.md",                 "06", "运动场所",                 "6"),
    ("07_校园生活设施.md",             "07", "校园生活设施",             "7"),
    ("08_快递点.md",                   "08", "快递点",                   "8"),
    ("09_证件办理充值及使用.md",       "09", "证件办理、充值及使用",      "9"),
    ("10_常用网址公众号电话及APP.md", "10", "常用网址、公众号、电话及APP", "10"),
    ("11_研究生会团总支各部门设置及工作内容简介.md", "11", "研究生会、团总支各部门", "11"),
    ("12_结尾寄语.md",                 "12", "结尾寄语",                 "12"),
]
...
def main():
    ...
    data = {
        "meta": {
            "category": BOOK_ID,
            "bookTitle": "研究生新生手册 2026",
            "org": "厦门大学信息学院（特色化示范性软件学院）",
            "producedBy": "厦门大学信息学院研究生会 · 研究生团总支 出品",
            "source": "《2026级研究生新生手册》docx 整理，经人工校对",
        },
        "chapters": chapters,
    }
